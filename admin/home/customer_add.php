...
<main>
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4 mt-3">
            ...
            <li class="breadcrumb-item active"><a href="./customer" class="text-decoration-none">Customers</a></li>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="add_customer" id="editButton" class="btn btn-success">Yes</button>
                        </div>
                    </div>
                </div>
            </div>
